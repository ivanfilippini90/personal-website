const Page = () => {
  // Option A - RECOMMENDED: if you rename the file to /public/sports-bg.png
  const bgUrl = "/sports-bg.png";

  // Option B - if you kept the original filename with spaces/commas in /public:
  // const bgUrl = encodeURI("/ChatGPT Image Nov 10, 2025, 08_22_37 PM.png");
  ...
  return (
    ...
    >
      {/* semitransparent overlay keeps text readable */}
      <div className="min-h-screen flex flex-col">
        ...
        {/* Bio Section */}
        <section className="px-6 py-16 text-center text-white flex-1">
        ...
        <section className="py-16 text-center">
          <div className="bg-white/8 backdrop-blur-sm p-8 rounded-2xl shadow-lg max-w-4xl mx-auto text-white">
        ...
        {/* Footer Section */}
        <footer className="py-6 bg-black bg-opacity-40 text-white text-center">
